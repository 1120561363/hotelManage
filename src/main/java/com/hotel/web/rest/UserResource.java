...
public class UserResource {
    ...
    @Timed
    public ResponseEntity<User> login(@RequestBody User user) throws URISyntaxException, ValidationException {
        System.out.println("###########################");
        User result = userService.getUserWithAuthoritiesByLogin(user.getLogin()).get();
        if(result == null){
    ...
    @Timed
    @Transactional
    public ResponseEntity<Void> updateUser(@RequestBody User user) throws URISyntaxException {
    ...
    public ResponseEntity<ManagedUserDTO> updateUser(@RequestBody ManagedUserDTO managedUserDTO) throws URISyntaxException {
       ...
       *//* userService.updateUser(managedUserDTO);
        ...
        return userRepository
            .findOneByLogin(managedUserDTO.getLogin())
            .map(user -> {
                user.setFirstName(managedUserDTO.getFirstName());
                user.setAuth(managedUserDTO.getAuth());
                user.setSex(managedUserDTO.getSex());
                ...
                return ResponseEntity.ok()
                    ...
                    .body(new ManagedUserDTO(userRepository
                        .findOneByLogin(managedUserDTO.getLogin()).get()));
            })
